...
public class UnLimit91PornItem implements Serializable {
  ...
  public String toString() {
    return "UnLimit91PornItem{" + "id="
        ...
        + status
        + ", favoriteDate="
        + DateFormat.format(Constants.DATE_FORMAT_YEAR_MONTH_DAY_HOUR_MINUTE_SECOND,
            favoriteDate == null ? new Date() : favoriteDate)
        + ", addDownloadDate="
        + DateFormat.format(Constants.DATE_FORMAT_YEAR_MONTH_DAY_HOUR_MINUTE_SECOND,
            addDownloadDate == null ? new Date() : addDownloadDate)
        + ", finshedDownloadDate="
        + DateFormat.format(Constants.DATE_FORMAT_YEAR_MONTH_DAY_HOUR_MINUTE_SECOND,
            finshedDownloadDate == null ? new Date() : finshedDownloadDate) + '}';
  }
}

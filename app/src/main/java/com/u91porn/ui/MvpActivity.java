...
/**
 * An Activity that uses a {@link MvpPresenter} to implement a
...
public abstract class MvpActivity<V extends MvpView, P extends MvpPresenter<V>> extends
    BaseAppCompatActivity implements MvpView,
   ...
   * <p>
   * <p>
   * <b>Please note that only one instance of mvp delegate should be used per
   * Activity instance</b>.
   * </p>
   * <p>
   * <p>

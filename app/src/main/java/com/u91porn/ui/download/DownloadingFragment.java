 ...
 */
public class DownloadingFragment extends MvpFragment<DownloadView, DownloadPresenter> implements
    DownloadManager.DownloadStatusUpdater, DownloadView {
  ...
  public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
    ...
    mUnLimit91Adapter = new UnLimit91Adapter(R.layout.item_right_menu_delete,
    ...
    mUnLimit91Adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
      ...
      public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        if (view.getId() == R.id.right_menu_delete) {
          ...
          boolean isSuccess = FileDownloader.getImpl().clear(unLimit91PornItem.getDownloadId(),
          ...
          if (unLimit91PornItem.getStatus() == FileDownloadStatus.progress
            ...
            DownloadManager.getImpl().startDownload(unLimit91PornItem.getVideoUrl(),
                unLimit91PornItem.getDownLoadPath());

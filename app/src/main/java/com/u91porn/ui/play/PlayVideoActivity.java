 ...
 * @author flymegoc
 */
public class PlayVideoActivity extends MvpActivity<PlayVideoView, PlayVideoPresenter> implements
    PlayVideoView {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    unLimit91PornItem = (UnLimit91PornItem) getIntent().getSerializableExtra(
        Keys.KEY_INTENT_UNLIMIT91PORNITEM);
